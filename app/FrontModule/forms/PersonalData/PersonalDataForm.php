...
class PersonalDataForm extends Control{
    ...
    public function __construct(OrderService $orderService, $freeDeliveryWeek = false)
    {
        Debugger::barDump($freeDeliveryWeek);
    ...
    public function personalDataFormSucceeded(Form $form, ArrayHash $values){
        ...
        $this->orderService->newOrder($values, $sessionProducts, $sessionShipping, $sessionPayment, $sessionOrder, $this->freeDeliveryWeek);
